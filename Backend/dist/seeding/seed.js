...
async function seed(dataSource) {
    ...
    const typeRepo = dataSource.getRepository(Types_1.Types);
    const categoryRepo = dataSource.getRepository(Categories_1.Categories);
    const subCategoryRepo = dataSource.getRepository(SubCategories_1.SubCategories);
    const productRepo = dataSource.getRepository(Products_1.Products);
    const productImagesRepo = dataSource.getRepository(ProductImages_1.ProductImages);
    const userRepo = dataSource.getRepository(Users_1.Users);
    const addressRepo = dataSource.getRepository(Address_1.Address);
    const orderRepo = dataSource.getRepository(Orders_1.Orders);
    const orderedProductsRepo = dataSource.getRepository(OrderedProducts_1.OrderedProducts);
    const paymentsRepo = dataSource.getRepository(Payments_1.Payments);
    const reviewsRepo = dataSource.getRepository(Reviews_1.Reviews);
    ...
    for (const p of productTemplates) {
        const product = productRepo.create({
            ...
            expiry_date: p.expiryDaysAhead ? daysAhead(p.expiryDaysAhead) : null,
    ...
    // ─── USERS ────────────────────────────────────────────────────────────────
    const defaultHash = await bcrypt_1.default.hash('Password123!', 10);
    const adminHash = await bcrypt_1.default.hash('Admin@UrbanKart1', 10);
    const usersData = [
        { name: 'Admin User', email: 'admin@urbankart.com', phone: '9800000001', role: Users_1.UserRole.Admin, isActive: true, passwordHash: adminHash },
        { name: 'Alice Johnson', email: 'alice.johnson@email.com', phone: '9800000002', role: Users_1.UserRole.Customer, isActive: true, passwordHash: defaultHash },
        { name: 'Bob Smith', email: 'bob.smith@email.com', phone: '9800000003', role: Users_1.UserRole.Customer, isActive: true, passwordHash: defaultHash },
        { name: 'Carol Williams', email: 'carol.williams@email.com', phone: '9800000004', role: Users_1.UserRole.Customer, isActive: true, passwordHash: defaultHash },
        { name: 'David Brown', email: 'david.brown@email.com', phone: '9800000005', role: Users_1.UserRole.Customer, isActive: true, passwordHash: defaultHash },
        { name: 'Eva Martinez', email: 'eva.martinez@email.com', phone: '9800000006', role: Users_1.UserRole.Customer, isActive: true, passwordHash: defaultHash },
        { name: 'Frank Wilson', email: 'frank.wilson@email.com', phone: '9800000007', role: Users_1.UserRole.Customer, isActive: true, passwordHash: defaultHash },
        { name: 'Grace Lee', email: 'grace.lee@email.com', phone: '9800000008', role: Users_1.UserRole.Customer, isActive: true, passwordHash: defaultHash },
        { name: 'Henry Taylor', email: 'henry.taylor@email.com', phone: '9800000009', role: Users_1.UserRole.Customer, isActive: true, passwordHash: defaultHash },
        { name: 'Isla Anderson', email: 'isla.anderson@email.com', phone: '9800000010', role: Users_1.UserRole.Customer, isActive: true, passwordHash: defaultHash },
        { name: 'Jack Thomas', email: 'jack.thomas@email.com', phone: '9800000011', role: Users_1.UserRole.Customer, isActive: true, passwordHash: defaultHash },
        { name: 'Karen Jackson', email: 'karen.jackson@email.com', phone: '9800000012', role: Users_1.UserRole.Customer, isActive: true, passwordHash: defaultHash },
        { name: 'Liam White', email: 'liam.white@email.com', phone: '9800000013', role: Users_1.UserRole.Customer, isActive: true, passwordHash: defaultHash },
        { name: 'Mia Harris', email: 'mia.harris@email.com', phone: '9800000014', role: Users_1.UserRole.Customer, isActive: true, passwordHash: defaultHash },
        { name: 'Noah Clark', email: 'noah.clark@email.com', phone: '9800000015', role: Users_1.UserRole.Customer, isActive: true, passwordHash: defaultHash },
    ];
    const savedUsers = [];
    ...
    const scenarios = [
        ...
        { status: Orders_1.OrderStatus.Delivered, payMethod: Payments_1.PaymentMethod.Credit, payStatus: Payments_1.PaymentStatus.Completed },
        { status: Orders_1.OrderStatus.Delivered, payMethod: Payments_1.PaymentMethod.Debit, payStatus: Payments_1.PaymentStatus.Completed },
        { status: Orders_1.OrderStatus.Delivered, payMethod: Payments_1.PaymentMethod.Cash, payStatus: Payments_1.PaymentStatus.Completed },
        { status: Orders_1.OrderStatus.Delivered, payMethod: Payments_1.PaymentMethod.Bank, payStatus: Payments_1.PaymentStatus.Completed },
        // Shipped + paid online (completed) or COD (still pending)
        { status: Orders_1.OrderStatus.Completed, payMethod: Payments_1.PaymentMethod.Credit, payStatus: Payments_1.PaymentStatus.Completed },
        { status: Orders_1.OrderStatus.Completed, payMethod: Payments_1.PaymentMethod.Debit, payStatus: Payments_1.PaymentStatus.Completed },
        { status: Orders_1.OrderStatus.Completed, payMethod: Payments_1.PaymentMethod.Cash, payStatus: Payments_1.PaymentStatus.Pending },
        { status: Orders_1.OrderStatus.Completed, payMethod: Payments_1.PaymentMethod.Bank, payStatus: Payments_1.PaymentStatus.Completed },
        // Pending order - paid online (processing) or unpaid COD/bank
        { status: Orders_1.OrderStatus.Pending, payMethod: Payments_1.PaymentMethod.Credit, payStatus: Payments_1.PaymentStatus.Completed },
        { status: Orders_1.OrderStatus.Pending, payMethod: Payments_1.PaymentMethod.Debit, payStatus: Payments_1.PaymentStatus.Completed },
        { status: Orders_1.OrderStatus.Pending, payMethod: Payments_1.PaymentMethod.Cash, payStatus: Payments_1.PaymentStatus.Pending },
        { status: Orders_1.OrderStatus.Pending, payMethod: Payments_1.PaymentMethod.Bank, payStatus: Payments_1.PaymentStatus.Pending },
        // Cancelled - paid then cancelled (refunded) or cancelled before payment
        { status: Orders_1.OrderStatus.Cancelled, payMethod: Payments_1.PaymentMethod.Credit, payStatus: Payments_1.PaymentStatus.Refunded },
        { status: Orders_1.OrderStatus.Cancelled, payMethod: Payments_1.PaymentMethod.Debit, payStatus: Payments_1.PaymentStatus.Refunded },
        { status: Orders_1.OrderStatus.Cancelled, payMethod: Payments_1.PaymentMethod.Bank, payStatus: Payments_1.PaymentStatus.Refunded },
        { status: Orders_1.OrderStatus.Cancelled, payMethod: Payments_1.PaymentMethod.Cash, payStatus: Payments_1.PaymentStatus.Pending },
    ];
